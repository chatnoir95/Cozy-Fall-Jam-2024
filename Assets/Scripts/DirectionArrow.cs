...
public class DirectionArrow : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (store.transform.position.x < SelectCharacter.playerCharacters.transform.position.x &&
            store.transform.position.y == SelectCharacter.playerCharacters.transform.position.y)
        {
        ...
        the store's x position */
        else if (store.transform.position.x > SelectCharacter.playerCharacters.transform.position.x &&
            store.transform.position.y == SelectCharacter.playerCharacters.transform.position.y)
        {
